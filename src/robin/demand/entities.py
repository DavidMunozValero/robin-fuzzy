...
from ..decision_model.utils import get_variables_from_dict, get_rules_from_dict
from ..supply.entities import Seat, Service
...
class UserPattern:
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f'id={self.id}, '
            f'name={self.name}, '
            f'behaviour_rules={self.behaviour_rules}, '
            f'behaviour_variables={self.behaviour_variables}, '
